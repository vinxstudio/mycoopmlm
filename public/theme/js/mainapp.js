        ...
        handleSound: function () {
            if($('.page-sound').length){
                ion.sound({
                    ...
                    path: BlankonApp.handleBaseURL()+'/public/assets/global/plugins/bower_components/ionsound/sounds/',
                    preload: true
                });
        ...
        handleTypehead: function () {
            if($('.typeahead').length){
                ...
                repos = new Bloodhound({
                    ...
                    prefetch: BlankonApp.handleBaseURL()+'/public/assets/global/plugins/bower_components/typehead.js/dist/typeahead-sample.json'
                });
...
var BlankonDemo = function () {
    ...
    // SETTINGS APP
    // =========================================================================
    var adminCssPath = BlankonApp.handleBaseURL()+'/public/assets/admin/css';
