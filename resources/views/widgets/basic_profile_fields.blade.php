...
<div class="form-group">
    ...
    <input type="text" name="email" placeholder="{{ Lang::get('members.email') }}" value="{{ old('email', isset($user->details->email) ? $user->details->email : null) }}" class="form-control" readonly>
</div>
<div class="form-group">
