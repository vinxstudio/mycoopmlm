        ...
        <tbody>
            ...
            @else
                @foreach($news as $n)
                    <tr>
                        <td>{{ $n->news_title }}</td>
                        <td>{{ $n->news_details }}</td>
                        <td>{{ $n->display_date }}</td>
                        <td>{{ $n->news_from }}</td>
                        <td>
                            <label class="switch">
                              <input data="{{ $n->id }}" class="a_status" type="checkbox" {{ $n->status == 1 ? "checked" : "" }}>
                        ...
                        <td>{{ $n->updated_at }}</td>
                        <td>
                            <a data="{{ $n->id }}" class="btn btn-warning btn-xs a_edit" data-toggle="modal" data-target="#news_edit" href="javascript:void(0);">
                                <i class="fa fa-pencil"></i>
                            </a>
                            <a data="{{ $n->id }}" class="btn btn-danger btn-xs a_delete" data-toggle="modal" data-target="#news_warning" href="javascript:void(0);">
