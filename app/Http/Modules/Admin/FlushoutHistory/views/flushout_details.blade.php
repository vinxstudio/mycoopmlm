    ...
    {{ Form::open(['class'=>'form-horizontal form-bordered']) }}
       ...
       <div class='col-md-3'>
            ...
            <div class="form-group pull-right">
                <label>&nbsp;</label>
                <div class='input-group date'>
                    <a class="btn btn-success pull-right" href="{{ url('/admin/export-flushoutdetails/xlsx/'.$account_id.'/'.$date_from.'/'.$date_to) }}"><i class="fas fa-download"></i> Download Flushout History Reports</a>
                </div>
            </div>
        </div>
    {{ Form::close() }}

    {{ view('widgets.flushout.flushout-list-details')->with([
