...
@section('content')
	<label><h1>Matching Bonus Report</h1></label>
	{{ Form::open(['class'=>'form-horizontal form-bordered']) }}
	    ...
	    <div class='col-md-3'>
	        <div class="form-group pull-right">
	        	<label>&nbsp;</label>
	            <div class='input-group date'>
	                <a class="btn btn-success pull-right" href="{{ url('admin/export-payout-history/xlsx/MB/'.$date_from.'/'.$date_to) }}"><i class="fas fa-download"></i> Download Matching Bonus Reports</a>
	            </div>
	        </div>
	    </div>
	{{ Form::close() }}
