...
namespace App\Http\Modules\Member\PayoutHistory\Controllers;
...
class PayoutHistoryMemberController extends MemberAbstract{

    protected $viewpath = 'Member.PayoutHistory.views.';
    ...
    function getIndex(){
        //$earnings = Earnings::groupBy('user_id')->paginate(100);
		$earnings = Earnings::groupBy('user_id')
							->where('user_id', $this->theUser->id)
							->get();
		$counter = 0;
