...
class DashboardMemberController extends MemberAbstract
{
    ...
    function getIndex()
    {
        ...
        # Disabled Redundant Binary Income in Weekly Payout
        #$data['t_rend_income'] = $account_summary['t_rend_income'];
        ...
        $data['redundant_binary_income'] = AvailableBalance::where(['group_id' => $this->theUser->group_id, 'source' => AvailableBalance::SOURCE_REDUNDANT_BINARY_INCOME])->pluck('available_balance');
    ...
    function accountSummary($user_group_ids)
    {
        ...
        foreach ($user_group_ids as $user_id) {
            ...
            #$activation = ActivationCodes::where('user_id', $user_id)->first();
            ...
            $total_rend_income = Earnings::where('user_id', $user_id)
                ->where('source', Earnings::SOURCE_REDUNDANT)
                ->sum('amount');
            ...
            $rend_income = $rend_income + $total_rend_income;
        }
        $data = array(
    ...
    function calPayout($start, $end, $user_ids, $start_date = null)
    {
         ...
         * Old Totalearnings
         * 
         * $Totalearnings Redundant Binary Income not included
         * 
         * $Totalearnings = $TotalDRI + $TotalMSBI; 
         */
